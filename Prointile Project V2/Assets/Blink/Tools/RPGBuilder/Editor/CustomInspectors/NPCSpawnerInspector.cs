    ...
    public override void OnInspectorGUI()
    {
        ...
        if (Spawner.OverrideLevels)
        {
            ...
            if (!Spawner.ScaleWithPlayer)
            {
                ...
                Spawner.MaxLevel = EditorGUILayout.IntField("Min. Level", Spawner.MaxLevel);
            }
        ...
        if (Spawner.OverrideRespawn)
        {
            ...
            Spawner.MaxRespawn = EditorGUILayout.FloatField("Min. Respawn", Spawner.MaxRespawn);
            GUILayout.Space(5);
        }
        ...
        GUILayout.Space(5);
        Spawner.gizmoColor = EditorGUILayout.ColorField("Circle Color", Spawner.gizmoColor);
        if (!Spawner.usePosition)
        {
            Spawner.lineColor = EditorGUILayout.ColorField("Line Color", Spawner.lineColor);
        }
