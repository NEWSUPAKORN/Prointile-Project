...
namespace BLINK.RPGBuilder.AI
{
    public class AIStateCombat : AIState
    {
        ...
        public override void Enter()
        {
            ...
            TimeBeforeNextCombatAction = Time.time + Random.Range(combatTemplate.minimumAttackInterval, combatTemplate.maximumAttackInterval);
            IsActive = true;
            InitMovement();
        ...
        public virtual bool CanAttack()
        {
            ...
            if (ThisAIEntity.GetAbilities()[randomAbility].ability
                    .ranks[ThisAIEntity.GetAbilities()[randomAbility].abilityRank].targetType ==
            ...
            RotateDuringAttack = ThisAIEntity.GetAbilities()[randomAbility].ability
                .ranks[ThisAIEntity.GetAbilities()[randomAbility].abilityRank].LookAtTargetDuringCombatAction;
