...
namespace BLINK.RPGBuilder.AI
{
    public class NPCSpawner : MonoBehaviour
    {
        ...
        public Coroutine ExecuteSpawnerCoroutine;
        ...
        {
            NPCSpawnerSaverTemplate saverTemplate = PersistenceManager.Instance.GetNPCSpawnerTemplateData(Saver.GetIdentifier());
            ...
            foreach (var npc in saverTemplate.persistentNPCs)
            {
                ...
                CombatEntity newNPC = CombatManager.Instance.GenerateNPCEntity(npcEntry, false, true, null, npc.position, Quaternion.Euler(npc.rotation), this);
        ...
        private void SpawnNPC()
        {
            ...
            CombatEntity newNPC = CombatManager.Instance.GenerateNPCEntity(pickedNPC.npc, false, pickedNPC.Persistent, null, GetNPCPosition(), transform.rotation, this);
        ...
        public void ManualSpawnNPC()
        {
            ...
            CombatEntity newNPC = CombatManager.Instance.GenerateNPCEntity(pickedNPC.npc, false, false, null, GetNPCPosition(),
