...
public class RPGAbility : RPGBuilderDatabaseEntry
{
    ...
    public void UpdateEntryData(RPGAbility newEntryData)
    {
        ...
        TooltipText = newEntryData.TooltipText;
    }
    ...
    public void CopyEntryData(RPGAbilityRankData original, RPGAbilityRankData copied)
    {
        ...
        for (var index = 0; index < copied.VisualEffectEntries.Count; index++)
        {
            VisualEffectEntry newVisualEffectEntry = new VisualEffectEntry
            {
                ...
                Template =
                {
                    SoundTemplates = copied.VisualEffectEntries[index].Template.SoundTemplates,
                    Prefabs = copied.VisualEffectEntries[index].Template.Prefabs,
                    ParentSoundToPrefab = copied.VisualEffectEntries[index].Template.ParentSoundToPrefab,
                    IsDestroyedOnDeath = copied.VisualEffectEntries[index].Template.IsDestroyedOnDeath,
                    IsDestroyedOnStun = copied.VisualEffectEntries[index].Template.IsDestroyedOnStun,
                    IsDestroyedOnStealth = copied.VisualEffectEntries[index].Template.IsDestroyedOnStealth,
                    IsDestroyedOnStealthEnd = copied.VisualEffectEntries[index].Template.IsDestroyedOnStealthEnd
                },
