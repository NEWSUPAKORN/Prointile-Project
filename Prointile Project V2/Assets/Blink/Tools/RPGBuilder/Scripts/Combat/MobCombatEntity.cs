...
namespace BLINK.RPGBuilder.Combat
{
    public class MobCombatEntity : CombatEntity
    {
        ...
        public override void InitStats()
        {
            ...
            StatCalculator.ResetLinkedStats(GameState.playerEntity);
            StatCalculator.ProcessLinkedStats(this);
        ...
        public override void EntityDeath()
        {
            ...
            if (Spawner != null)
            {
                if(Spawner.ExecuteSpawnerCoroutine != null) Spawner.StopCoroutine(Spawner.ExecuteSpawnerCoroutine);
                Spawner.ExecuteSpawnerCoroutine = Spawner.StartCoroutine(Spawner.ExecuteSpawner(Spawner.OverrideRespawn
