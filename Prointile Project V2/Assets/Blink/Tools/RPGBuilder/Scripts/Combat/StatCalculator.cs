...
namespace BLINK.RPGBuilder.Logic
{
    public static class StatCalculator
    {
        ...
        public static void UpdateLevelUpStats()
        {
            ...
            ResetLinkedStats(GameState.playerEntity);
            ProcessLinkedStats(GameState.playerEntity);
        ...
        public static void UpdateWeaponTemplateLevelUpStats(int weaponTemplateID)
        {
            ...
            foreach (var weaponTemplateStat in wpTemplate.stats.Where(weaponTemplateStat => weaponTemplateStat.bonusPerLevel != 0))
            {
                HandleStat(GameState.playerEntity, GameDatabase.Instance.GetStats()[weaponTemplateStat.statID], GameState.playerEntity.GetStats()[weaponTemplateStat.statID], weaponTemplateStat.bonusPerLevel, weaponTemplateStat.isPercent, TemporaryStatSourceType.none);
        ...
        public static void UpdateSkillLevelUpStats(int skillID)
        {
            ...
            foreach (var skillStat in thisSkill.stats.Where(skillStat => skillStat.bonusPerLevel != 0))
            {
                HandleStat(GameState.playerEntity, GameDatabase.Instance.GetStats()[skillStat.statID], GameState.playerEntity.GetStats()[skillStat.statID], skillStat.bonusPerLevel, skillStat.isPercent, TemporaryStatSourceType.none);
        ...
        public static void ProcessLinkedStats (CombatEntity entity)
        {
        ...
        public static void ResetLinkedStats (CombatEntity entity)
        {
            int statsAffectingMovementSpeed = 0;
        ...
        private static List<VitalityStateBeforeChangesDATA> getVitStates()
        {
            List<VitalityStateBeforeChangesDATA> vitStates = new List<VitalityStateBeforeChangesDATA>();
            foreach (var statData in GameState.playerEntity.GetStats())
            {
                ...
                VitalityStateBeforeChangesDATA newVitState = new VitalityStateBeforeChangesDATA
                {
                    ...
                    percent = CombatUtilities.GetCurrentStatValue(GameState.playerEntity, statData.Value.stat.ID) /
                              CombatUtilities.GetMaxStatValue(GameState.playerEntity, statData.Value.stat.ID)
                };
        ...
        public static void CalculateItemStats()
        {
            ...
            foreach (var vitState in vitStates)
            {
                ...
                float newValue = CombatUtilities.GetMaxStatValue(GameState.playerEntity, statREF.ID);
                ...
                CombatUtilities.SetCurrentStatValue(GameState.playerEntity, statREF.ID, (int) newValue);

                ClampStat(statREF, GameState.playerEntity);

                TriggerStatEvents(GameState.playerEntity, statREF.ID);
                CombatEvents.Instance.OnStatsChanged(GameState.playerEntity);
            }
        ...
        public static void CalculateEffectsStats(CombatEntity combatEntity)
        {
            ...
            ResetLinkedStats(combatEntity);
            ProcessLinkedStats(combatEntity);
            if(statsAffectingMovementSpeed > 0) TriggerMovementSpeedChange(combatEntity);
        }
