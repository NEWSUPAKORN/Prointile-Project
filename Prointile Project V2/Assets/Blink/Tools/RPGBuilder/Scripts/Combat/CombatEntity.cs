...
namespace BLINK.RPGBuilder.Combat
{
    public class CombatEntity : MonoBehaviour, IPlayerInteractable
    {
        ...
        public virtual void InitMount(RPGEffect effect, int rankIndex)
        {
            ...
            ThisAnimator.SetBool(effect.ranks[rankIndex].MountAnimationParameter, true);
        }
        ...
        public virtual void ResetMount()
        {
            ...
            ThisAnimator.SetBool(mountEffect.ranks[mountEffectRank].MountAnimationParameter, false);
            mountEffect = null;
            mountEffectRank = -1;
        }
