...
namespace BLINK.RPGBuilder.Managers
{
    public class GameDatabase : MonoBehaviour
    {
        ...
        Dictionary<string, RPGBStatCategory> StatCategory = new Dictionary<string, RPGBStatCategory>();
        public Dictionary<string, RPGBStatCategory> GetStatCategory()
        {
            return StatCategory;
        }
        ...
        private void LoadGameData()
        {
            ...
            StatCategory = Resources.LoadAll<RPGBStatCategory>(editorDATA.RPGBDatabasePath + "Types").ToDictionary(t => t.entryName, t => t);
