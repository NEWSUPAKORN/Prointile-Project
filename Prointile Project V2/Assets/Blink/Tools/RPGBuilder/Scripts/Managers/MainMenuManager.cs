...
namespace BLINK.RPGBuilder.Managers
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        public void SelectGender(int index)
        {
            ...
            {
                foreach (var gender in GameDatabase.Instance.GetRaces()[raceSlot.raceID].Genders)
                {
                    if (gender.Gender != currentlySelectedGender) continue;
                    raceSlot.icon.sprite = RPGBuilderUtilities.getRaceIconByID(raceSlot.raceID);
                }
            }
