...
namespace BLINK.RPGBuilder.UI
{
    public class ScreenSpaceNameplates : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            UIEvents.ResetNameplate += ResetNameplate;
        ...
        private void ResetNameplate(CombatEntity entity)
        {
            foreach (var t in AllNameplates.Where(t => t.InUse).Where(t => t.Entity == entity))
            {
        ...
        public void UpdateEntityNameplate(CombatEntity entity)
        {
            foreach (var t in AllNameplates.Where(t => t.InUse).Where(t => t.Entity == entity))
            {
                t.Renderer = entity.mainRenderer;
                t.PosYOffset = entity.GetAIEntity().GetCurrentNPCPreset().NameplateYOffset;
            }
        }
