...
namespace BLINK.RPGBuilder.UI
{
    public class AbilityTooltip : MonoBehaviour
    {
        ...
        private void GenerateTooltip(CombatEntity entity, RPGAbility ability, RPGAbility.RPGAbilityRankData rank)
        {
            ...
            string description = GenerateBaseTooltipText(entity, ability);
            int texts = 0;
        ...
        private string GenerateBaseTooltipText(CombatEntity entity, RPGAbility ability)
        {
            string text = ability.TooltipText;
